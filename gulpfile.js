// Generated on 2016-04-04 using generator-jhipster 3.0.0
'use strict';
...
gulp.task('copy', function () {
    return es.merge(
        ...
        gulp.src([config.app + 'robots.txt', config.app + 'favicon.ico', config.app + '.htaccess'], {
            dot: true
        })
        .pipe(plumber({
            errorHandler: handleErrors
...
gulp.task('watch', function () {
    ...
    gulp.watch([config.app + '*.html', config.app + 'app/**', config.app + 'i18n/**'])
